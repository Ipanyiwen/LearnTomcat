...
public class ManifestResource {
    ...
    public boolean isFulfilled() {
        ...
        while (it.hasNext()) {
            org.apache.catalina.util.Extension ext = (org.apache.catalina.util.Extension)it.next();
    ...
    private ArrayList getRequiredExtensions(Manifest manifest) {
        ...
        while (true) {
            ...
            if (value == null)
                continue;
            org.apache.catalina.util.Extension extension = new org.apache.catalina.util.Extension();
    ...
    private ArrayList getAvailableExtensions(Manifest manifest) {
        ...
        org.apache.catalina.util.Extension extension = new Extension();
