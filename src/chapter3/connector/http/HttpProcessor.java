...
import chapter3.ServletProcessor;
import chapter3.StaticResourceProcessor;
import chapter3.util.StringManager;
import chapter3.util.RequestUtil;
...
public class HttpProcessor {
    ...
    protected StringManager sm = StringManager
            .getManager("chapter3.connector.http");
    ...
    public void process(Socket socket) {
        try {
            ...
            response.setHeader("Server", "Java Servlet Container");
